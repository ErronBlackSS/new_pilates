...
const Main = () => {
  return (
    <>
      <div className="w-[1366px] flex flex-col m-auto mobile-below:w-[320px]">
        ...
        <div className="mt-[117px] mb-[59px]">
        ...
        <div className="flex flex-row w-full justify-between overflow-x-scroll scrollbar-hide">
          <div className="flex items-center">
          ...
          <div className="flex flex-row gap-[32px]">   
            <div>
              ...
              <div>
                <div className="relative w-[389px] h-[178px]">  
        ...
        <div className="flex mt-[95px] mb-[27px]">
        ...
        <div className="flex flex-row w-full">
          <div className="ml-[25px] mb-[90px] ">
            <ul className="w-[672px] list-disc list-[#D11655] text-[19px] text-[#D11655] mobile-below:w-[320px]">
              <li> 
          ...
          <div className="w-full mobile-below:invisible mobile-below:w-[0px] mobile-below:h-[0px]">
            <div >
              <img className="m-auto" src="http://localhost:5000/files/girl.png" alt="mainImage" />
            </div>
          </div>
        </div>
        <div className="mt-[100px] mb-[44px] shadow-md">
          <h1 className="text-[16px] text-[#464646] ml-[5px] mb-[10px]">улица Свердлова, 26, Ярославль</h1>
          <iframe src="https://yandex.ru/map-widget/v1/?um=constructor%3Ad4ed878e0e7a2f1ce4ecff230377877f8cf25bc282569d380d2a761d1f7489d6&amp;source=constructor" width="100%" height="395" frameBorder="0"></iframe>
        </div>
        
      </div>
      <div>
        <footer className="bg-[#FFFEFE] md:p-5 dark:bg-gray-800">
          <div className="flex flex-row justify-between w-full px-[55px]">
