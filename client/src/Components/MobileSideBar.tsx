...
const MobileSideBar = () => {
  ...
  return (
    <>
      <div
        className={ 'z-[100] h-screen fixed flex flex-col bg-[#FFFEFE] gap-[20px] transition-all duration-500 items-center' + (isToggled ? ' w-[250px]' : ' hidden') }
        id="sidebar"
        ref={bodyRef}
      >
        <div className={'flex flex-col gap-[40px] mt-[40px] justify-center ' + (isToggled ? ' items-start' : ' items-center')}>
          <Icon
            onClick={toMainPage}
          >
            <div className="flex flex-row justify-center items-center gap-[10px] cursor-pointer mb-[10px]">
              <IconLogo />
      ...
      <div className="flex-row w-full justify-between mobile-above:hidden mobile-below:flex mb-[10px]">
        <svg
          onClick={toMainPage}
